...
departmentRouter.post(
  ...
  async (request, response) => {
    ...
    // Create a list
    // Populte it with the employee Ids.
    ...
    // employees as reference.

    await department.employees.forEach(async (employee) => {
      // Add the created department id to the employee department list
      employee.department = employee.department.concat(savedDepartment._id);

      // Update the employee to reflect the newly created department
